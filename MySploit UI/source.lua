-- MySploit UI / Version 1.3.2 (UPDATED BY RILEYBEERBLX)
...
function PageLibrary.AddButton(Text, Callback, Parent, Underline)
    ...
    HiddenButton.Position = UDim2.new(0, 5, 0, 0)
...
function PageLibrary.AddSection(Text)
			local SectionContainer = Frame()
			SectionContainer.Name = Text.."SECTION"
			SectionContainer.Size = UDim2.new(1,0,0,20)
			SectionContainer.BackgroundTransparency = 1
			SectionContainer.Parent = DisplayPage
			
			local SectionForeground = RoundBox(5)
			SectionForeground.Name = "SectionForeground"
			SectionForeground.ImageColor3 = Color3.fromRGB(45,45,45)
			SectionForeground.Size = UDim2.new(1,0,1,0)
			SectionForeground.Parent = SectionContainer
			
			local HiddenSection = TextLabel(Text, 12)
			HiddenSection.Parent = SectionForeground		
end
...
function PageLibrary.AddDropdown(Text, ConfigurationArray, Callback)
    ...
    DropdownExpander.Position = UDim2.new(1, -20, 0.5, -10)
    ...
    DropdownExpander.MouseButton1Down:Connect(function()
        ...
        DropdownFrame.Visible = DropdownToggle
...
function PageLibrary.AddColourPicker(Text, DefaultColour, Callback)
    ...
    LabelContainer.Size = UDim2.new(1, 0, 0, 20)
    LabelContainer.BackgroundTransparency = 1
    LabelContainer.Parent = PickerContainer
    ...
    PickerLeftSide.Parent = LabelContainer
    ...
    PickerRightSide.Parent = LabelContainer
    ...
    PickerLabel.Size = UDim2.new(1, -10, 1, 0)
    ...
    function PageLibrary.AddKeybind(Text, DefaultKey, Callback, Parent, Underline)
    local KeybindContainer = Frame()
    KeybindContainer.Name = Text.."KEYBIND"
    KeybindContainer.Size = UDim2.new(1, 0, 0, 20)
    KeybindContainer.BackgroundTransparency = 1
    KeybindContainer.Parent = Parent or DisplayPage

    local KeybindForeground = RoundBox(5)
    KeybindForeground.Name = "KeybindForeground"
    KeybindForeground.Size = UDim2.new(1, 0, 1, 0)
    KeybindForeground.ImageColor3 = Color3.fromRGB(35, 35, 35)
    KeybindForeground.Parent = KeybindContainer
    ...
    if Underline then
        ...
        BottomEffect.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        BottomEffect.BackgroundTransparency = 0.5
        BottomEffect.Parent = KeybindForeground
    end
    ...
    Label.Parent = KeybindForeground

    local KeybindButton = TextButton(DefaultKey, 12)
    KeybindButton.Size = UDim2.new(0, 30, 1, 0)
    KeybindButton.Position = UDim2.new(1, -35, 0, 0)
    KeybindButton.Parent = KeybindForeground
...
function PageLibrary.AddInput(Text, DefaultText, Callback, Parent, Underline)
    local InputContainer = Frame()
    InputContainer.Name = Text .. "INPUT"
    InputContainer.Size = UDim2.new(1, 0, 0, 20)
    InputContainer.BackgroundTransparency = 1
    InputContainer.Parent = Parent or DisplayPage

    local InputForeground = RoundBox(5)
    InputForeground.Name = "InputForeground"
    InputForeground.Size = UDim2.new(1, 0, 1, 0)
    InputForeground.ImageColor3 = Color3.fromRGB(35, 35, 35)
    InputForeground.Parent = InputContainer
    ...
    if Underline then
        ...
        BottomEffect.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        BottomEffect.BackgroundTransparency = 0.5
        BottomEffect.Parent = InputForeground
    end

    local InputLabel = TextLabel(Text, 12)
    InputLabel.Size = UDim2.new(0.5, -5, 1, 0)
    InputLabel.Position = UDim2.new(0, 5, 0, 0)
    InputLabel.TextXAlignment = Enum.TextXAlignment.Left
    InputLabel.Parent = InputForeground

    local InputBox = TextBox(DefaultText or "", 12)
    InputBox.Size = UDim2.new(0.5, -10, 1, 0)
    InputBox.Position = UDim2.new(0.5, 5, 0, 0)
    InputBox.BackgroundTransparency = 1
    InputBox.TextXAlignment = Enum.TextXAlignment.Left
    InputBox.Parent = InputForeground
...
function PageLibrary.AddSlider(Text, ConfigurationDictionary, Callback, Parent)
    ...
    SliderButton.MouseButton1Down:Connect(function(input)
        ...
        SliderMove = UserInputService.InputChanged:Connect(function(moveInput)
...
function PageLibrary.AddToggle(Text, Default, Callback)
    ...
    ToggleLeftSide.Size = UDim2.new(1, -30, 1, 0)
